    ...
    <div class="max-w-3xl mx-auto text-center">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        ...
        <a
          ...
          target="_blank"
          class="flex items-center gap-2.5 px-5 py-3 rounded-xl bg-bg border border-border text-slate-400 hover:text-white hover:border-sky-400/30 text-sm font-medium transition-all duration-200"
        >
        ...
        <a
          ...
          target="_blank"
          class="flex items-center gap-2.5 px-5 py-3 rounded-xl bg-bg border border-border text-slate-400 hover:text-white hover:border-emerald-400/30 text-sm font-medium transition-all duration-200"
        >
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
